...
use [our template on GitHub](https://github.com/gamepark/board-dekal)
...
Once you have one Material type and one Location type, you can start to setup a new game in [GameTemplateRules.ts](/rules/src/DekalRules.ts)
